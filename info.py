...
PICS = (environ.get('PICS', 'https://files.catbox.moe/tc89xm.jpg')).split()
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002457410637'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002313570116').split()]  # For Multiple Id Use One Space Between Each.
